...
export const AdminSidebar: React.FC<SidebarProps> = ({ isCollapsed, onToggle }) => {
  ...
  const firstNameInitial = user?.fullName.split(' ')[0][0] || 'N';
  const lastNameInitial = user?.fullName.split(' ')[1][0] || 'A';
  ...
  const isActiveRoute = (to: string) => {
    // TODO: Ajustarlo cunado estemos en la pantalla de producto
